...
export function InnerOptionValue({
  ...
  const unavailableClass = !isAvailable
    ? 'after:h-px after:w-[150%] after:rotate-[135deg] after:absolute after:top-1/2 after:left-1/2 after:-translate-x-1/2 after:-translate-y-1/2 after:bg-mediumGray text-normalGray overflow-hidden'
    : '';
