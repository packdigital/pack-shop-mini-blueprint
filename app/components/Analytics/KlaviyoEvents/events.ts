...
import {mapCartLine, mapProductPageVariant} from './utils';
...
const viewProductQuickShopEvent = ({
  ...
  const analyticsEvent = AnalyticsEvent.PRODUCT_QUICK_SHOP_VIEWED;
  try {
...
export {addToCartEvent, customerSubscribeEvent, viewProductQuickShopEvent};
