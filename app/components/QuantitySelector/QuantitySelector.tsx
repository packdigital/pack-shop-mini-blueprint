  ...
  return (
    <div className="flex w-full max-w-[6.5rem] items-center justify-between">
      <button
        ...
        } ${disableDecrement ? 'cursor-not-allowed' : 'md:hover:border-normalGray'}`}
      ...
      <button
        ...
        className={`relative size-8 rounded-full border border-border transition disabled:opacity-50 md:hover:border-normalGray ${
          hideButtons ? 'invisible' : ''
        } ${disableIncrement ? 'cursor-not-allowed' : 'md:hover:border-normalGray'}`}
