...
export function Select({
  ...
  return (
    ...
    >
      ...
      >
        <ListboxOptions
          className={`absolute left-1/2 z-10 flex max-h-72 w-full -translate-x-1/2 flex-col gap-0 overflow-hidden overflow-y-auto rounded-lg border border-normalGray bg-background py-2 text-base ${
            openFrom === 'top'
