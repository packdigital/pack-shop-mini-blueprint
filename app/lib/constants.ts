...
export const PROMOBAR_HEIGHT_MOBILE = 44; /* Ensure this number (px) is equivalent to --promobar-height-mobile in app.css */
export const PROMOBAR_HEIGHT_DESKTOP = 44; /* Ensure this number (px) equivalent to --promobar-height-desktop in app.css */
